...
CREATE DATABASE `kan_wikipedia_2021_300K`;

USE `kan_wikipedia_2021_300K`;
...
LOAD DATA LOCAL INFILE 'kan_wikipedia_2021_300K-words.txt' INTO TABLE words;
LOAD DATA LOCAL INFILE 'kan_wikipedia_2021_300K-sentences.txt' INTO TABLE sentences;
LOAD DATA LOCAL INFILE 'kan_wikipedia_2021_300K-co_s.txt' INTO TABLE co_s;
LOAD DATA LOCAL INFILE 'kan_wikipedia_2021_300K-co_n.txt' INTO TABLE co_n;
LOAD DATA LOCAL INFILE 'kan_wikipedia_2021_300K-inv_w.txt' INTO TABLE inv_w;
LOAD DATA LOCAL INFILE 'kan_wikipedia_2021_300K-inv_so.txt' INTO TABLE inv_so;
LOAD DATA LOCAL INFILE 'kan_wikipedia_2021_300K-sources.txt' INTO TABLE sources;
